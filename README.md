...
- homo_sapiens
  ...
  - pacbio:
    ...
    - bam:
      ...
      - sample_pacbio_longread_dna.aligned.bam: WGS aligned reads generated by pbmm2, containing RG information
      - sample_pacbio_longread_dna.aligned.bai: BAM index for 'sample_pacbio_longread_dna.aligned.bam'
    - bed:
