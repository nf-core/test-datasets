  ...
  - metagenome
    ...
    - taxonomy
      ...
      - misc
        ...
        - taxa_sqlite.xz: taxa.sqlite database file downloaded with ete3, compressed with xz
        - taxa_sqlite_traverse.pkl: taxa.sqlite.traverse.pkl file downloaded with ete3
      - taxdump
