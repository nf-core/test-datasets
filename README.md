...
* homo_sapines
  * pangenome
    * 'pangenome.fa.gz': A FASTA file which contains several related genomes for the input of `wfmash`.
    * 'pangenome.paf.gz': A PAF file which contains the pairwise alignments of related genomes. Ideally, it was generated by `wfmash`. It is consumed by `seqwish`.
