...
- prokaryotes
  ...
  - metagenome
    ...
    - taxonomy
	  ...
	  - taxdump
        - taxdump.tar.gz: A NCBI taxdump.tar.gz file from 2025-08-06 filtered to just include information relevant to tax ids of the SARS-CoV2 and _Haemophilus influenzae_ taxa under `metagenome/fasta/`  
  - streptococcus_agalactiae
    - genome
      - emu
