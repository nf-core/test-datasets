...
- proteinfamilies
  - mgnify_proteins.faa: An amino acid fasta file of metagenomics derived sequences predicted through the `MGnify` assemply analysis pipeline. The file contains 204 sequences, a size that allows family generation algorithms to execute fast, and also generate enough families to test.
