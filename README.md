...
- homo_sapiens
  ...
  - illumina
    ...
    - bam:
      ...
      - 'test.rna.Aligned.unsorted.bam': STAR-aligned, unsorted, paired-end RNAseq bam file from the test*rnaseq*{1,2}.fastq.gz: chr22 of sample GM12878 (SRA accession: SRX2900878)
      - 'test.rna.Aligned.sorted.bam': STAR-aligned, sorted, paired-end RNAseq bam file based on test.rna.Aligned.unsorted.bam
      - 'test.rna.Aligned.sorted.bam.bai': STAR-aligned, sorted paired-end RNAseq bam index file for test.rna.Aligned.sorted.bam
      - umi:
