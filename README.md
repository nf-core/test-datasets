...
`testdata/uncompressed/*.fastq`: Uncompressed versions of select paired-end samples for testing uncompressed FASTQ input support
...
`samplesheet/v3.10/samplesheet_test_uncompressed.csv`: Experiment design file with mixed compressed/uncompressed samples for testing input handling  
