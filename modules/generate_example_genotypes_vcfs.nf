process GENERATE_EXAMPLE_GENOTYPES_VCFS {
    ...
    do
      echo "Checking \$url"
      curl -I --fail --connect-timeout 10 --max-time 30 \$url
    done
    touch ALL.chr1.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf.gz
    touch ALL.chr22.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf.gz
    touch ALL.chrX.phase3_shapeit2_mvncall_integrated_v1c.20130502.genotypes.vcf.gz
    """
}