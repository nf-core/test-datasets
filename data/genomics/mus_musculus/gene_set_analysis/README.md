...
- `shinyngs/treatment_mCherry_hND6_.mh.all.v2022.1.Mm.symbols.gsea_report_for_hND6.tsv` gene sets enriched toward the target (`hND6`) for the `treatment_mCherry_hND6_` contrast.
- `shinyngs/treatment_mCherry_hND6_.mh.all.v2022.1.Mm.symbols.gsea_report_for_mCherry.tsv` gene sets enriched toward the reference (`mCherry`) for the `treatment_mCherry_hND6_` contrast.
- `shinyngs/treatment_mCherry_hND6_sample_number.mh.all.v2022.1.Mm.symbols.gsea_report_for_hND6.tsv` gene sets enriched toward the target (`hND6`) for the `treatment_mCherry_hND6_sample_number` contrast.
- `shinyngs/treatment_mCherry_hND6_sample_number.mh.all.v2022.1.Mm.symbols.gsea_report_for_mCherry.tsv` gene sets enriched toward the reference (`mCherry`) for the `treatment_mCherry_hND6_sample_number` contrast.
